...
exp/win > 1 means the window mode wins.  Measured so far: M2 Ultra
0.71-0.99 (loses; the cache hierarchy absorbs the redundant reads),
M4 1.0-1.7 at conc=1 and 1.6-2.1 at conc 4-32 for 8K+ context.
