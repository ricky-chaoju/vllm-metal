...
4. Test the draft wheel with representative attention types, including Qwen3 (GQA) and Qwen3.5 (hybrid SDPA + GDN), plus speculative decoding on a non-hybrid target.
